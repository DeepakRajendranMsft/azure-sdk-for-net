...
namespace Microsoft.Azure.Management.Network
{
   ...
   using Models;
    ...
    public static partial class NetworkManagementClientExtensions
    {
            ...
            /// </param>
            public static async System.Threading.Tasks.Task<DnsNameAvailabilityResult> CheckDnsNameAvailabilityAsync(this INetworkManagementClient operations, string location, string domainNameLabel = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
