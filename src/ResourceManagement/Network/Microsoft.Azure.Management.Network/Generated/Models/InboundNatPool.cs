...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class InboundNatPool : SubResource
    {
        ...
        /// port range for the NAT pool. You can specify any port number you
        ...
        /// range for the NAT pool. You can specify any port number you
        /// choose, but the port numbers specified for each role in the
        /// service must be unique. Possible values range between 1 and
        /// 65535, inclusive</param>
        ...
        /// internal component on a port that is different from the one that
